        ...
        for obj, obj_tracks in tracks.items():
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id, _ in obj_tracks[frame_num].items():
                    ...
                    start_position = obj_tracks[frame_num][track_id][
                        "position_transformed"
                    ]
                    end_position = obj_tracks[last_frame][track_id][
                        "position_transformed"
                    ]
                    ...
                    for frame_num_batch in range(frame_num, last_frame):
                        if track_id not in tracks[obj][frame_num_batch]:
                            continue
                        tracks[obj][frame_num_batch][track_id]["speed"] = (
                            speed_km_per_hour
                        )
                        tracks[obj][frame_num_batch][track_id]["distance"] = (
                            total_distance[obj][track_id]
                        )
